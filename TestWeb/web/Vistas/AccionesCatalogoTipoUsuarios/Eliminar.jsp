...
<html>
    ...
    <body>
        <h1 style="color: red">¿Estas seguro de eliminar este registro?</h1>
        ...
        %>
        <form method="post" action="<%= path %>/EliminarTipoUsuario">
            <div class="col-md-4" > 
            ...
            <div class="col-md-4" > 
                ...
                <input class="form-control" readonly="true" type="text" name="descripcion"  placeholder="Descripción" value="<%= e.getDescripcion()%>"/>
            </div>
